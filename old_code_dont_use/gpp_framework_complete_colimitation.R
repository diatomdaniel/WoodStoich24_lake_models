...
source("models/static_liebig_no_light_colimitation.R") # model 1 in Carly's framework
# Droop model
source("models/dynamic_liebig_no_light_colimitation.R") # model 3 in Carly's framework
# set timesteps
...
seston.figs <- ggarrange(plotlist = list(cnp.plt, gpp.cnp.plt), align = "hv", nrow = 2, 
                         labels = c("a", "b"), common.legend = T, legend = "bottom")
seston.figs

# save figures individually
# save_plot("figures/gpp_framework_colimited.png", gpp.plt, base_width = 5, base_height = 8)
# save_plot("figures/seston_framewor_colimited.png", seston.figs, base_height = 10, base_width = 7)
