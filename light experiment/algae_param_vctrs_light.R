...
static.algae <- c(
  ...
  KLight1 = traits[11, "average"] 
)
names(static.algae) <- c("SA", "zmix", "Pin", "Nin", "HRT", "I0", "kBg", "kA", "umax1", "lA", "v", 
                         "KP1",  "QP1", "KN1",  "QN1", "KLight1")
names(static.algae)
...
static.diatoms <- c(
  ...
  KLight1 = traits[11, "diatoms"] 
)
names(static.diatoms) <- c("SA", "zmix", "Pin", "Nin", "HRT", "I0", "kBg", "kA",  "umax1", "lA", "v", 
                           "KP1",  "QP1", "KN1",  "QN1", "KLight1")
...
static.greens <- c(
  ...
  KLight1 = traits[11, "greens"] 
)
names(static.greens) <- c("SA", "zmix", "Pin", "Nin", "HRT", "I0", "kBg", "kA", "umax1", "lA", "v", 
                          "KP1",  "QP1", "KN1",  "QN1", "KLight1")
names(static.greens)
...
static.cyanos <- c(
  ...
  KLight1 = traits[11, "cyanos"] 
)
names(static.cyanos) <- c("SA", "zmix", "Pin", "Nin", "HRT", "I0", "kBg", "kA", "umax1", "lA", "v",
                          "KP1",  "QP1", "KN1",  "QN1", "KLight1")
names(static.cyanos)
...
names(dynamic.greens) <- c("SA", "zmix", "Pin", "Nin", "HRT", "I0", "kBg", "kA",
...
names(dynamic.cyanos) <- c("SA", "zmix", "Pin", "Nin", "HRT", 
                           "I0", "kBg", "kA",
                           "umax1", "lA", "v", "KP1", 
                           "minQP1", "upP1", "KN1", "minQN1", "upN1", "KLight1")
