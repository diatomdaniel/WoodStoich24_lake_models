...
(traits.fig <- fresh.traits %>%
  ggplot() + 
  geom_violin(aes(taxon.new, (Trait.Value), fill = taxon.new), color = "black") + 
  geom_point(aes(taxon.new, (Median.Trait.Value)), color = "black", size = 2) + 
  #geom_text(aes(taxon.new, -Inf, label = paste("n = ", n)), vjust = -0, col = "white") +
