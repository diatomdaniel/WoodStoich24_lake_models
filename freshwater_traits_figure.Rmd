...
# some quick numerical editing for KN and KP
fresh.traits <- fresh.traits %>%
  mutate(Trait.Value = ifelse(Trait.new == "KN", Trait.Value * 1000, Trait.Value),
         Trait.Value = ifelse(Trait.new == "KP", Trait.Value * 1000, Trait.Value),
         Median.Trait.Value = ifelse(Trait.new == "KN", Median.Trait.Value * 1000, Median.Trait.Value),
         Median.Trait.Value = ifelse(Trait.new == "KP", Median.Trait.Value * 1000, Median.Trait.Value))
